...
export default function ChatPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-slate-100 dark:bg-slate-950">
      <div className="flex items-center justify-between gap-4 px-6 py-4 bg-white dark:bg-slate-900 shadow-sm border-b border-slate-200 dark:border-slate-800">
